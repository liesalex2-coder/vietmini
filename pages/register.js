        ...
        <div style={{ width: '100%', maxWidth: step === 2 ? '560px' : '400px' }}>
          ...
          {step === 1 && (
            <div style={{ background: '#fff', borderRadius: '16px', padding: '40px', boxShadow: '0 4px 24px rgba(26,10,0,0.08)' }}>
              ...
              <button onClick={signInWithFacebook} style={{ width: '100%', padding: '11px', borderRadius: '8px', border: 'none', background: '#1877F2', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', fontSize: '14px', fontWeight: '600', color: '#fff', cursor: 'pointer', marginBottom: '10px', fontFamily: "'Be Vietnam Pro', sans-serif" }}>
