...
const SERVICES = {
  salon: {
    ...
    catImgs: [10, 5, 9],
    items: [
      { cat: 'Tóc',    name: 'Cắt tóc nữ',      price: 120000, img: 10 },
      { cat: 'Tóc',    name: 'Uốn tóc',          price: 350000, img: 10 },
      { cat: 'Tóc',    name: 'Nhuộm tóc',        price: 450000, img: 10 },
      { cat: 'Tóc',    name: 'Hấp dầu + dưỡng',  price: 180000, img: 10 },
      { cat: 'Nail',   name: 'Sơn gel tay',       price: 150000, img: 5 },
      { cat: 'Nail',   name: 'Sơn gel chân',      price: 120000, img: 5 },
      { cat: 'Nail',   name: 'Đắp bột',           price: 220000, img: 5 },
      { cat: 'Makeup', name: 'Makeup cô dâu',     price: 800000, img: 9 },
      { cat: 'Makeup', name: 'Makeup dự tiệc',    price: 400000, img: 9 },
    ]
  },
  barber: {
    ...
    catImgs: [6, 8],
    items: [
      { cat: 'Tóc',    name: 'Cắt tóc nam',           price: 80000,  img: 6 },
      { cat: 'Tóc',    name: 'Cắt + gội',              price: 110000, img: 6 },
      { cat: 'Tóc',    name: 'Nhuộm tóc nam',          price: 250000, img: 6 },
      { cat: 'Tóc',    name: 'Uốn / duỗi',             price: 300000, img: 6 },
      { cat: 'Da mặt', name: 'Cạo mặt + đắp mặt nạ',  price: 120000, img: 8 },
      { cat: 'Da mặt', name: 'Chăm sóc da mặt',        price: 180000, img: 8 },
    ]
  },
  spa: {
    ...
    catImgs: [6, 8, 10],
    items: [
      { cat: 'Massage',      name: 'Massage body 60 phút',       price: 350000,  img: 6 },
      { cat: 'Massage',      name: 'Massage body 90 phút',       price: 480000,  img: 6 },
      { cat: 'Massage',      name: 'Massage đá nóng',            price: 520000,  img: 6 },
      { cat: 'Chăm sóc da',  name: 'Đắp mặt nạ dưỡng da',       price: 220000,  img: 8 },
      { cat: 'Chăm sóc da',  name: 'Tẩy tế bào chết toàn thân', price: 380000,  img: 8 },
      { cat: 'Liệu trình',   name: 'Liệu trình 5 buổi',          price: 1500000, img: 10 },
      { cat: 'Liệu trình',   name: 'Liệu trình 10 buổi',         price: 2800000, img: 10 },
    ]
  },
  resto: {
    ...
    catImgs: [5, 8, 10],
    items: [
      { cat: 'Phở & Bún', name: 'Phở bò tái',      price: 65000, img: 5 },
      { cat: 'Phở & Bún', name: 'Phở bò chín',      price: 65000, img: 5 },
      { cat: 'Phở & Bún', name: 'Bún bò Huế',       price: 60000, img: 7 },
      { cat: 'Cơm',       name: 'Cơm sườn nướng',   price: 70000, img: 8 },
      { cat: 'Cơm',       name: 'Cơm gà xối mỡ',    price: 70000, img: 8 },
      { cat: 'Cơm',       name: 'Cơm tấm đặc biệt', price: 75000, img: 8 },
      { cat: 'Đồ uống',   name: 'Trà đá',            price: 10000, img: 10 },
      { cat: 'Đồ uống',   name: 'Sinh tố bơ',        price: 45000, img: 9 },
      { cat: 'Đồ uống',   name: 'Nước ép cam',       price: 40000, img: 10 },
    ]
  },
  gym: {
    ...
    catImgs: [6, 8, 9],
    items: [
      { cat: 'Thẻ tập',      name: 'Thẻ tháng',       price: 500000,  img: 6 },
      { cat: 'Thẻ tập',      name: 'Thẻ 3 tháng',     price: 1300000, img: 6 },
      { cat: 'Thẻ tập',      name: 'Thẻ 6 tháng',     price: 2400000, img: 6 },
      { cat: 'Thẻ tập',      name: 'Thẻ năm',         price: 4000000, img: 6 },
      { cat: 'PT cá nhân',   name: 'PT 1 buổi',       price: 300000,  img: 8 },
      { cat: 'PT cá nhân',   name: 'PT 10 buổi',      price: 2500000, img: 8 },
      { cat: 'Lớp học nhóm', name: 'Yoga (1 tháng)',  price: 600000,  img: 9 },
      { cat: 'Lớp học nhóm', name: 'Zumba (1 tháng)', price: 550000,  img: 10 },
    ]
  },
  karaoke: {
    ...
    catImgs: [6, 2, 2],
    items: [
      { cat: 'Phòng hát',  name: 'Phòng thường (1h)',   price: 80000,  img: 6 },
      { cat: 'Phòng hát',  name: 'Phòng VIP (1h)',      price: 150000, img: 6 },
      { cat: 'Phòng hát',  name: 'Phòng VIP (3h)',      price: 400000, img: 8 },
      { cat: 'Phòng hát',  name: 'Phòng đại sảnh (1h)', price: 300000, img: 8 },
      { cat: 'Đồ uống',    name: 'Bia Tiger (lon)',     price: 30000,  img: 2 },
      { cat: 'Đồ uống',    name: 'Nước ngọt',          price: 20000,  img: 2 },
      { cat: 'Đồ uống',    name: 'Rượu vang (chai)',   price: 350000, img: 2 },
      { cat: 'Đồ ăn nhẹ', name: 'Đĩa trái cây',       price: 120000, img: 2 },
      { cat: 'Đồ ăn nhẹ', name: 'Lẩu mini',           price: 200000, img: 2 },
    ]
  },
  pet: {
    ...
    catImgs: [5, 8, 9],
    items: [
      { cat: 'Vệ sinh',             name: 'Tắm + sấy (chó nhỏ)',    price: 120000, img: 5 },
      { cat: 'Vệ sinh',             name: 'Tắm + sấy (chó lớn)',    price: 180000, img: 6 },
      { cat: 'Vệ sinh',             name: 'Vệ sinh tai + cắt móng', price: 80000,  img: 5 },
      { cat: 'Tạo kiểu',            name: 'Cắt tỉa lông (chó nhỏ)', price: 200000, img: 8 },
      { cat: 'Tạo kiểu',            name: 'Cắt tỉa lông (chó lớn)', price: 300000, img: 8 },
      { cat: 'Tạo kiểu',            name: 'Thơm lông + nơ',         price: 100000, img: 8 },
      { cat: 'Chăm sóc sức khỏe',  name: 'Tắm trị ve',             price: 150000, img: 9 },
      { cat: 'Chăm sóc sức khỏe',  name: 'Chăm sóc răng miệng',    price: 120000, img: 9 },
    ]
  },
  boutique: {
    ...
    catImgs: [2, 3, 4],
    items: [
      { cat: 'Thời trang', name: 'Áo nữ',         price: 250000, img: 2 },
      { cat: 'Thời trang', name: 'Quần nữ',        price: 280000, img: 2 },
      { cat: 'Thời trang', name: 'Đầm dự tiệc',    price: 650000, img: 2 },
      { cat: 'Thời trang', name: 'Set đồ casual',  price: 420000, img: 2 },
      { cat: 'Phụ kiện',   name: 'Túi xách',       price: 380000, img: 3 },
      { cat: 'Phụ kiện',   name: 'Ví da',          price: 220000, img: 3 },
      { cat: 'Phụ kiện',   name: 'Khăn lụa',       price: 180000, img: 3 },
      { cat: 'Mỹ phẩm',   name: 'Son môi',         price: 120000, img: 4 },
      { cat: 'Mỹ phẩm',   name: 'Kem dưỡng da',    price: 280000, img: 4 },
    ]
  },
}
  ...
  try {
    ...
    await supabaseAdmin.from('service_categories').insert(
      svcData.categories.map((name, i) => ({
        ...
        name,
        display_order: i + 1,
        image_base64: `${BASE}/${vertical}/img_${svcData.catImgs[i] || i + 2}.webp`,
      }))
    )
    ...
    await supabaseAdmin.from('services').insert(
      svcData.items.map((s, i) => ({
        ...
        price: s.price,
        display_order: i + 1,
        image_base64: `${BASE}/${vertical}/img_${s.img}.webp`,
      }))
    )
